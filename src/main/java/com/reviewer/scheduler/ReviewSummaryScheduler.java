...
//
//        for (String projectContract : notUpdatedProjects) {
...
//                            column -> reviewService.sumAllColumnValueByProject(column, projectContract) //Modificar para hacer la media de la columna
//                    ));
//
...
//            }
//
//            reviewSummaryService.update(projectContract, evaluationSummary, totalReviews, avg);
//        }
//    }
//}
